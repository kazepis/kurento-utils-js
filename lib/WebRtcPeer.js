...
function WebRtcPeer(mode, options, callback) {
  ...
  if (!pc) {
    ...
    pc.oniceconnectionstatechange = e => console.log('ICE CONNECTION STATE:', e.currentTarget.iceConnectionState);
    pc.onicegatheringstatechange = e => console.log('ICE GATHERING STATE:', e.currentTarget.iceGatheringState);
    pc.onsignalingstatechange = e => console.log('SIGNALING STATE:', e.currentTarget.signalingState);
  }
...
function setMediaBitrate(sdp, media, bitrate) {
  ...
  this.processAnswer = function (sdpAnswer, callback) {
    ...
    var answer = new RTCSessionDescription({
      type: 'answer',
      sdp: setMediaBitrates(sdpAnswer)
    })
